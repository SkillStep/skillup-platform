create table if not exists "user_phone_identities" (
  ...
  constraint "user_phone_identities_e164" check ("phone_normalized" ~ '^\\+923[0-9]{9}$')
);
create unique index if not exists "user_phone_identities_phone_unique" on "user_phone_identities" ("phone_normalized");
create unique index if not exists "user_phone_identities_user_unique" on "user_phone_identities" ("user_id");
